...
namespace DemoDCProject.UnitTests.DemoDCProject.DomainLayer.Models
{
    [TestClass]
    public class BillingAccountSummaryTests
    {
        ...
        public void BillingAccountSummaryMappingTest()
        {
            ...
            Assert.AreEqual(10003, billingAccount.AccountId);
            Assert.AreEqual(00005, billingAccount.AccountReference);
            Assert.AreEqual(35.5500m, billingAccount.PastDueAmount);
            Assert.AreEqual("Active", billingAccount.AccountStatus);
