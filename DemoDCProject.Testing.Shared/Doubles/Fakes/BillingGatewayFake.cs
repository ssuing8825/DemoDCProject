...
namespace DemoDCProject.Testing.Shared.Doubles.Fakes
{
    ...
    {
        private readonly List<BillingAccountSummary> billingAccounts = new List<BillingAccountSummary>();

        private readonly List<AccountSearchResult> searchResults = new List<AccountSearchResult>();
        ...
        public BillingGatewayFake(TestMediator testMediator)
        {
            ...
            billingAccounts.Add(BillingAccountSummary.Fetch(@"<BillingObj.getAccountSummaryRs status=""success"">
            <Account 
                ...
                <NextScheduledInvoice 
                    xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"">
                    <InvoiceDate>2015-01-30T00:00:00</InvoiceDate>
                    <Amount>0.0000</Amount>
                    <InvoiceDueDate>2015-02-19T00:00:00</InvoiceDueDate>
                </NextScheduledInvoice>
                <Parties 
                    xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"">
                    <PartyRecord 
            ...
            searchResults.Add(AccountSearchResult.Fetch(@"<BillAccount.searchByAccountReferenceRs status=""success"">
                                                <CandidateList>
                                                    <SearchControl>
                                                        <Paging>
                                            ...
                                            </BillAccount.searchByAccountReferenceRs>"));
                                        ...
                                        <CandidateList>
                                            ...
                                            <ListItem>
                                                <ItemData>
                                                    ...
                                                    <AccountTypeCode>ACT</AccountTypeCode>
                                                    <AssociatedParties>
                                                        <Party PartyId=""20003"" Role=""Payor"" />
                                                        <Party PartyId=""20003"" Role=""Payee"" />
                                                    </AssociatedParties>
                                                </ItemData>
                                            </ListItem>
                                            <Parties 
        ...
        protected override async Task<BillingAccountSummary> RetrieveBillingAccountSummaryByAccountIdCore(int billingAccountId)
        {
            ...
            if (result == null) throw new Exception("Billing Account was not found. Do a search before retrieving an account");
            return result;
        }

        protected override async Task<AccountSearchResult> SearchForBillingAccountByPolicyIdCore(int policyId)
        {
            var result = searchResults.Where(c => c.AccountReference == policyId).FirstOrDefault();
            if (result == null) return searchResults[0];
            return result;
        }
    }
}
